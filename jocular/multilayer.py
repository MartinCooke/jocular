...
class MultiLayer(Component):
    ...
    def LRGB_changed(self, L=None, R=None, G=None, B=None):
        ...
        if L is None:
            # generate synthetic luminance (careful with scaling)
    ...
    def luminance_updated(self, lum):
        # called from monochrome if LRGB mode and user updates luminance control e.g. white
