''' This is the original pre-kivyMD toast which I think looks better than
    the new one; but is it responsible for the scatter bug?
'''
...
def toast(text: str, duration=2.5):
    ...
    OldToast(duration=duration).toast(text)
